...
namespace VoxelGame.Logic
{
    public abstract partial class Liquid
    {
        ...
        public static readonly Liquid Water = new BasicLiquid(Language.Water, nameof(Water), TextureLayout.Liquid("water_moving_side", "water_moving"), TextureLayout.Liquid("water_static_side", "water_static"));
