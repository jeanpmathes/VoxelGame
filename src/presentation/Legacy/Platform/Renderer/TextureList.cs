...
// todo: when the new UI no longer uses this, check if this can be removed and the Draw2D system be simplified to not rely on this

/// <summary>
///     Stores all loaded textures and provides methods to access them for the screen painting pipeline.
/// </summary>
public sealed class TextureList : IDisposable
{
    ...
    public TextureList(Client client)
    {
        ...
        // The 2D drawing pipeline requires at least one texture.
    ...
    /// </summary>
    /// <param name="drawer">The drawing pipeline.</param>
