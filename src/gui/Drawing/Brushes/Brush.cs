...
namespace VoxelGame.GUI.Drawing.Brushes;

/// <summary>
///     Defines a brush for drawing visual elements.
///     Brushes are always immutable.
/// </summary>
public abstract class Brush
{
    ...
    /// </summary>
    public static Brush Blue { get; } = new SolidColorBrush(ColorS.Blue);
