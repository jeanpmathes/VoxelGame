...
---------|----------|----------|----------------------------------------------------------------------------------------
 VG0001  | Usage    | Warning  | Prefer ToStringFast() over ToString() for enums.                                         
 VG0002  | Usage    | Warning  | Prefer ToStringFast() in string interpolation for enums.                                 
 VG0003  | Usage    | Warning  | The LateInitialization attribute must be used on partial non-nullable member properties. 
