...
/// <summary>
///     Represents an action that remains active while its input combination is held.
///     Use <see cref="Button.IsActive" /> to determine whether the action is active.
/// </summary>
public partial class SimpleButton : Button
{
    [Constructible]
    private SimpleButton(Binding binding) : base(binding) {}
