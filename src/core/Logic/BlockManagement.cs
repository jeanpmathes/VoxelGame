...
namespace VoxelGame.Core.Logic
{
    public abstract partial class Block : IBlockBase
    {
        ...
        public static readonly Block Farmland = new CoveredDirtBlock(Language.Farmland, nameof(Farmland), TextureLayout.UnqiueTop("dirt", "farmland"), TextureLayout.UnqiueTop("dirt_wet", "farmland_wet"), false);
        ...
        public static readonly Block Mud = new MudBlock("Mud", nameof(Mud), TextureLayout.Uniform("mud"), 0.1f);
