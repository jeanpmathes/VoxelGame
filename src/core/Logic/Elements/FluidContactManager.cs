...
public class FluidContactManager
{
    ...
    {
        if (MathTool.NearlyEqual(a.fluid.Density, b.fluid.Density)) return false;
    ...
    {
        (ContactInformation light, ContactInformation dense) = MathTool.ArgMinMax((a.fluid.Density, a), (b.fluid.Density, b));
