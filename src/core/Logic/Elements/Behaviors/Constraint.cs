...
/// But addressing those shortcomings would drastically increase the complexity of that system and would only be rarely used.
/// </summary>
public class Constraint : BlockBehavior, IBehavior<Constraint, BlockBehavior, Block>
{
    ...
    /// A state is invalid if there is no way to place the block in that state or have it change into that state through behavior.
    /// </summary>
