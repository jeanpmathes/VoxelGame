...
public sealed class DecorationLoader : IResourceLoader
{
    ...
    private static Sphere GetSphereCrown(Int32 totalHeight)
    {
    ...
    private static Spheroid GetLongSpheroidCrown(Int32 totalHeight)
    {
    ...
    private static Spheroid GetFlatSpheroidCrown(Int32 totalHeight)
    {
        const Double heightRatio = 3.0 / 4.0;
    ...
    private static Cone GetConeCrown(Int32 totalHeight)
    {
        const Double heightRatio = 3.0 / 4.0;
    ...
    private static Sphere GetPalmCrown(Int32 totalHeight)
    {
