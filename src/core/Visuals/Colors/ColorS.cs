...
namespace VoxelGame.Core.Visuals.Colors;
...
public readonly struct ColorS(Single red, Single green, Single blue, Single alpha = 1.0f) : IEquatable<ColorS>
{
    ...
    ///     Create a new color from the given channels.
    /// </summary>
    public static ColorS FromRGB32(Byte red, Byte green, Byte blue)
    {
        return Color32.FromRGBA(red, green, blue, Byte.MaxValue).ToColorS();
    }
    ...
    ///     Create a new color from the given channels.
    /// </summary>
    public static ColorS FromRGBA32(Byte red, Byte green, Byte blue, Byte alpha)
    {
        return Color32.FromRGBA(red, green, blue, alpha).ToColorS();
    }
