...
public static class Meshing
{
    ...
    {
        UInt32 x = MathTool.RoundedToUInt(vector.X * 16);
        UInt32 y = MathTool.RoundedToUInt(vector.Y * 16);
        UInt32 z = MathTool.RoundedToUInt(vector.Z * 16);
        UInt32 w = MathTool.RoundedToUInt(vector.W * 16);
