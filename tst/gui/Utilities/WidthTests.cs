// <copyright file="WidthTests.cs" company="VoxelGame">
...
public class WidthTests
{
    ...
    {
        Assert.Equal("Width.Zero", Width.Zero.ToString());
    }

    [Fact]
    public void WidthF_ToString_ShouldReturnNonZeroFormatForNonZeroRadius()
    {
        Assert.Equal("Width(Value: 5)", new Width(5.0f).ToString());
    }
}
