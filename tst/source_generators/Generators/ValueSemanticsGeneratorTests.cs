...
[TestSubject(typeof(ValueSemanticsGenerator))]
public class ValueSemanticsGeneratorTests
{
    ...
    [Fact]
    public void ValueSemanticsGenerator_ShouldIgnoreStaticAndConstFields()
    {
        const String oldText = """
                               using System;
                               using VoxelGame.Annotations.Attributes;
                               ...
                               public struct TestStruct
                               {
                                   public const Int32 DefaultX = 42;
                                   public static String Name = "Voxel";
                                   public Int32 X;
                               }
                               """;
