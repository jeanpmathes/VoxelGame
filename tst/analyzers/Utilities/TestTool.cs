...
public static class TestTool
{
    ...
    /// </summary>
    public static Func<Solution, ProjectId, Solution> DefaultSolutionTransform { get; } = (solution, projectId) => solution.WithProjectParseOptions(projectId, new CSharpParseOptions(
