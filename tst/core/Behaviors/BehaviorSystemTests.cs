...
public class BehaviorSystemTests
{
    ...
    {
        public static BehaviorA Construct(TestSubject subject)
        {
            return new BehaviorA(subject);
        }
    }
    ...
    {
        public static BehaviorB Construct(TestSubject subject)
        {
            return new BehaviorB(subject);
        }
    }
    ...
    {
        public static BehaviorC Construct(TestSubject subject)
        {
            return new BehaviorC(subject);
        }
    }
}
